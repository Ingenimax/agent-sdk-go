...
import (
	...
	"github.com/Ingenimax/agent-sdk-go/cmd/examples/graph/tools"
...
func main() {
	...
	log.Printf("Files Available in Temp Directory: %s", fileWriter.TempDir)
...
type ReviewResult struct {
	...
	TempDir           string   `json:"temp_dir" description:"Temporary directory"`
}
